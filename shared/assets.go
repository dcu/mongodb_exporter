...
func groups_yml() (*asset, error) {
	...
	info := bindata_file_info{name: "groups.yml", size: 23384, mode: os.FileMode(420), modTime: time.Unix(1423619283, 0)}
